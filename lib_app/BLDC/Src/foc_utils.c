...
#include "../Inc/foc_utils.h"

#include "math.h"

int sine_array[200] = {0,79,158,237,316,395,473,552,631,710,789,867,946,1024,1103,1181,1260,1338,1416,1494,
...
// Electrical angle calculation 计算电角度
// shaft_angle 当前机械角度
// pole_pairs 极对数 该电机为7
